...
public class Compiler extends JFrame{
    ...
    private GrammerAnalysis gsa;
    private List<Token> allToken;
    private List<EachSymbol> allSymbol;
    private List<EachPcode> allPcode;
    ...
    private void displayAllToken() {
        ...
        for (int i = 0; i < allToken.size(); i++) {
            ...
            Object[] rowValues = {token.getType(), token.getLine(), token.getValue()};
    ...
    private void displayAllSymbol() {
        ...
        for (int i = 0; i < allSymbol.size(); i++) {
            EachSymbol symbol = allSymbol.get(i);
    ...
    private void displayAllPcode() {
        ...
        for (int i = 0; i < allPcode.size(); i++) {
            EachPcode pcode = allPcode.get(i);
